...
const examNavButtonVariants = cva(
    "box-border flex flex-row justify-center items-center gap-2 h-[52px] rounded-[14px] font-normal text-base leading-6 text-center transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
    {
        variants: {
            variant: {
                prev: "bg-white border-2 border-[#D1D5DC] text-[#364153] hover:bg-[#F9FAFB] disabled:hover:bg-white",
                answer: "bg-[#364153] text-white hover:bg-[#1F2937] disabled:hover:bg-[#364153]",
                next: "bg-[#155DFC] text-white hover:bg-[#1447E6] disabled:hover:bg-[#155DFC]",
            },
            size: {
                default: "flex-1",
                fixed: "w-[290px]",
